...
python main.py -data cifar100 -gr 800 -algo FedCAG -m resnet10 -mstr resnet10 -nc 60 -ls 5 -car 100 -calr 25 -mmt 0.5 -ss 30 -gam 0.9 -lbs 32 -c 0.9 --noniid --balance --alpha_dirich 1 -nb 100