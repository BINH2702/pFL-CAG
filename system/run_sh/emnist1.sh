...
python3 main.py -log -data Cifar10 -gr 800 -algo FedAvg -m resnet10 -mstr resnet10 -nc 20 --noniid --balance --alpha_dirich 0.1 --alpha_dirich 1
python3 main.py -log -data Cifar10 -gr 400 -algo FedAvg -m resnet10 -mstr resnet10 -nc 20 --noniid --balance --alpha_dirich 1 --alpha_dirich 1
